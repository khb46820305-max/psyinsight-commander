...
### 🎯 시작하기
- **[프로젝트 맥락](./통합문서/기타가이드.md#프로젝트-맥락)** ⭐ **새로운 AI 세션 시작 시 필수 읽기**
- [사용 가이드](./통합문서/설정가이드.md#사용-가이드) - 사용 방법
- [배포 가이드](./통합문서/배포가이드.md) - 외부 배포 방법

### 📋 기획 및 설계
- [프로젝트 기획서](./통합문서/프로젝트기획서.md) - 전체 기능 명세

### 🔧 기술 문서
- [설정 가이드](./통합문서/설정가이드.md) - 이메일, 자동화, 스케줄러 설정
- [문제 해결](./통합문서/문제해결.md) - 문제 해결 가이드
- [기타 가이드](./통합문서/기타가이드.md) - 다른 PC 이동, 질문답변 등
